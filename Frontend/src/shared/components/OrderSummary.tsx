...
import { AddShoppingCart, LocalOffer, Payment } from "@mui/icons-material";
    ...
    >
      <Paper sx={{ mb: 2, p: 3, width: "100%", borderRadius: 3 }}>
        ...
        <Box mt={2}>
          ...
          >
            Checkout
            <Payment sx={{ marginLeft: 1 }} />
          </Button>
          <Button component={Link} to="/catalog" fullWidth>
            Continue Shopping <AddShoppingCart sx={{ marginLeft: 1 }} />
          </Button>
        </Box>
      </Paper>
